function [Mask_all] = Load_mask(Masks_folders,Mask_all,i)
...
if cellfun(@isempty,Masks_folders(i)) == 0
    ...
    elseif isempty(maskfound) == 1 
        ...
        quest_mask = questdlg(sprintf('Is there a mask in sample %s ?',Masks_folders{i}),'mask as .tiff','Yes','No','Cancel');
